...
??? exercise "Exercise 9.2 · Enrich your Part I dataset"
    ...
    ??? note "What good looks like"
        Enrichment is where Part I comes together: you're now *producing* the missing column from Chapter 2's exercise. A strong answer is honest about the seam — "I joined city population, but my population figures are 2021 estimates while my events are from 2026, so any per-capita rate is slightly off." Naming the imperfection is the professional move.
